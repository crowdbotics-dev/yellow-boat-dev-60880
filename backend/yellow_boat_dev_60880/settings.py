"""
Django settings for yellow_boat_dev_60880 project.
...
ROOT_URLCONF = 'yellow_boat_dev_60880.urls'
...
WSGI_APPLICATION = 'yellow_boat_dev_60880.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "yellow_boat_dev_60880 API",
    "DESCRIPTION": "API documentation for yellow_boat_dev_60880 App",
    "VERSION": "v1",
}
